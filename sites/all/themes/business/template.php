 ...
 */
function business_preprocess_comment_form__node_jobs(&$variables) {
...
function business_preprocess_comment(&$variables) {
...
function business_comment_post_forbidden($variables) {
	$node = $variables['node'];
	if($node->type=='jobs'){
		global $user;
